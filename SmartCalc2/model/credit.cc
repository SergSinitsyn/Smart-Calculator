...
void Credit::LoadData(double total_credit_amount, double term, double interest_rate)
{
    total_credit_amount_ = total_credit_amount;
    term_ = term;
    interest_rate_ = interest_rate;
...
std::tuple<std::vector<double>, double, double> Credit::AnnuityCredit() {
    ...
    monthly_payment_[0] = round_2dd(total_credit_amount_ *
