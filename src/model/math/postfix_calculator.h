...
class PostfixCalculator {
 public:
  ...
  std::list<MyNamespace::Token> ConvertInfixToPostfix(const std::list<Token> &);
  double PostfixNotationCalculation(const std::list<Token> &, double);
  double PostfixNotationCalculation(const std::list<Token> &);
