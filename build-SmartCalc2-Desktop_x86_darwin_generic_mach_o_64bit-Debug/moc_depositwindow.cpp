...
#include <memory>
#include "../SmartCalc2/view/depositwindow.h"
...
QT_MOC_LITERAL(14, 38), // "on_pushButton_addReplenishmen..."
QT_MOC_LITERAL(53, 0), // ""
QT_MOC_LITERAL(54, 31), // "on_pushButton_Calculate_clicked"
QT_MOC_LITERAL(86, 53), // "on_comboBox_PeriodicityOfPaym..."
QT_MOC_LITERAL(140, 5) // "index"

    },
    "DepositWindow\0on_pushButton_addReplenishment_clicked\0"
    "\0on_pushButton_Calculate_clicked\0"
    "on_comboBox_PeriodicityOfPayments_currentIndexChanged\0"
    "index"
};
...
void DepositWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->on_pushButton_addReplenishment_clicked(); break;
        case 1: _t->on_pushButton_Calculate_clicked(); break;
        case 2: _t->on_comboBox_PeriodicityOfPayments_currentIndexChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}
