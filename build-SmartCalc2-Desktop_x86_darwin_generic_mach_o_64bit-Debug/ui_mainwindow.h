...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        gridLayout->addWidget(toolButton_3, 5, 6, 1, 1);
        ...
        gridLayout->addWidget(toolButton_4, 4, 4, 1, 1);
        ...
        toolButton_1->setMinimumSize(QSize(40, 40));

        gridLayout->addWidget(toolButton_1, 5, 4, 1, 1);
        ...
        gridLayout->addWidget(toolButton_7, 3, 4, 1, 1);
        ...
        gridLayout->addWidget(toolButton_6, 4, 6, 1, 1);
        ...
        toolButton_0->setMinimumSize(QSize(40, 40));

        gridLayout->addWidget(toolButton_0, 6, 4, 1, 1);
        ...
        gridLayout->addWidget(toolButton_8, 3, 5, 1, 1);
        ...
        sizePolicy1.setHeightForWidth(lineEdit_input_x->sizePolicy().hasHeightForWidth());
        lineEdit_input_x->setSizePolicy(sizePolicy1);
        lineEdit_input_x->setFrame(true);
        ...
        gridLayout->addWidget(toolButton_9, 3, 6, 1, 1);
        ...
        sizePolicy2.setHeightForWidth(lineEdit_iuput->sizePolicy().hasHeightForWidth());
        lineEdit_iuput->setSizePolicy(sizePolicy2);
        lineEdit_iuput->setFrame(true);
        ...
        gridLayout->addWidget(toolButton_5, 4, 5, 1, 1);
        ...
        gridLayout->addWidget(toolButton_2, 5, 5, 1, 1);
        ...
        QWidget::setTabOrder(lineEdit_iuput, lineEdit_output);
        QWidget::setTabOrder(lineEdit_output, toolButton_x);
        QWidget::setTabOrder(toolButton_x, lineEdit_input_x);
        QWidget::setTabOrder(lineEdit_input_x, toolButton_deleteAll);
        QWidget::setTabOrder(toolButton_deleteAll, toolButton_backspace);
        QWidget::setTabOrder(toolButton_backspace, toolButton_equal);
        QWidget::setTabOrder(toolButton_equal, toolButton_pi);
        QWidget::setTabOrder(toolButton_pi, toolButton_mod);
        QWidget::setTabOrder(toolButton_mod, toolButton_openBracket);
        QWidget::setTabOrder(toolButton_openBracket, toolButton_closeBracket);
        QWidget::setTabOrder(toolButton_closeBracket, toolButton_7);
        QWidget::setTabOrder(toolButton_7, toolButton_8);
        QWidget::setTabOrder(toolButton_8, toolButton_9);
        QWidget::setTabOrder(toolButton_9, toolButton_div);
        QWidget::setTabOrder(toolButton_div, toolButton_sin);
        QWidget::setTabOrder(toolButton_sin, toolButton_asin);
        QWidget::setTabOrder(toolButton_asin, toolButton_exp);
        QWidget::setTabOrder(toolButton_exp, toolButton_power);
        QWidget::setTabOrder(toolButton_power, toolButton_4);
        QWidget::setTabOrder(toolButton_4, toolButton_5);
        QWidget::setTabOrder(toolButton_5, toolButton_6);
        QWidget::setTabOrder(toolButton_6, toolButton_mult);
        QWidget::setTabOrder(toolButton_mult, toolButton_cos);
        QWidget::setTabOrder(toolButton_cos, toolButton_acos);
        QWidget::setTabOrder(toolButton_acos, toolButton_ln);
        QWidget::setTabOrder(toolButton_ln, toolButton_sqrt);
        QWidget::setTabOrder(toolButton_sqrt, toolButton_1);
        QWidget::setTabOrder(toolButton_1, toolButton_2);
        QWidget::setTabOrder(toolButton_2, toolButton_3);
        QWidget::setTabOrder(toolButton_3, toolButton_sub);
        QWidget::setTabOrder(toolButton_sub, toolButton_tan);
        QWidget::setTabOrder(toolButton_tan, toolButton_atan);
        QWidget::setTabOrder(toolButton_atan, toolButton_log);
        QWidget::setTabOrder(toolButton_log, toolButton_qbrt);
        QWidget::setTabOrder(toolButton_qbrt, toolButton_0);
        QWidget::setTabOrder(toolButton_0, toolButton_point);
        QWidget::setTabOrder(toolButton_point, toolButton_E);
        QWidget::setTabOrder(toolButton_E, toolButton_add);

        menubar->addAction(menu->menuAction());
        menu->addAction(actionEngineer_Calculator);
        menu->addAction(actionGraph_View);
        menu->addSeparator();
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        toolButton_3->setText(QCoreApplication::translate("MainWindow", "3", nullptr));
        ...
        toolButton_4->setText(QCoreApplication::translate("MainWindow", "4", nullptr));
        ...
        toolButton_1->setText(QCoreApplication::translate("MainWindow", "1", nullptr));
        ...
        toolButton_7->setText(QCoreApplication::translate("MainWindow", "7", nullptr));
        ...
        toolButton_6->setText(QCoreApplication::translate("MainWindow", "6", nullptr));
        ...
        toolButton_0->setText(QCoreApplication::translate("MainWindow", "0", nullptr));
        ...
        toolButton_8->setText(QCoreApplication::translate("MainWindow", "8", nullptr));
        ...
        toolButton_9->setText(QCoreApplication::translate("MainWindow", "9", nullptr));
        toolButton_mult->setText(QCoreApplication::translate("MainWindow", "*", nullptr));
        toolButton_5->setText(QCoreApplication::translate("MainWindow", "5", nullptr));
        toolButton_2->setText(QCoreApplication::translate("MainWindow", "2", nullptr));
